...
//   console.log(`I am here inside google api route`)
...
//       audience: clientId,
//       redirectUri: process.env.NEXT_ENV == "development" ? "http://localhost:3000" : 'worldguessr.com',
//     });
...
export default async function handler(req, res) {
  ...
  console.log(`Hello in the api routes , I am here`)
